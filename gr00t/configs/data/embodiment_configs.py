...
MODALITY_CONFIGS = {
    ...
    "new_embodiment": {
        ...
        "action": ModalityConfig(
            ...
            action_configs=[
                # left_arm: RELATIVE means model learns deltas from current joint angles
                # Dataset stores ABSOLUTE joint angles, processor converts to relative during training
                ActionConfig(
                    rep=ActionRepresentation.RELATIVE,
                    type=ActionType.NON_EEF,
                    format=ActionFormat.DEFAULT,
